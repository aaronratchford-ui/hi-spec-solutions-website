  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        ...
        maintenance — for homeowners, housing associations and councils. CHAS
        registered and SIKA approved.
      </p>
      <div className="mt-10 flex flex-col justify-center gap-4 sm:flex-row sm:gap-x-6">
        <Button href="/contact" color="purple">
          Get a free quote
        </Button>
        <Button href={company.phoneHref} variant="outline" color="slate">
          <svg
            aria-hidden="true"
            className="h-4 w-4 flex-none fill-purple-600"
            viewBox="0 0 16 16"
          >
      ...
      <div className="mt-16 lg:mt-20">
        ...
        >
          {credentials.map((item) => (
            <li
              key={item.name}
              className="rounded-2xl bg-white px-5 py-6 text-center shadow-sm ring-1 ring-slate-900/5"
            >
